...
_FLUFF_TEMPLATES = (
    ...
    "у {name} лень раньше петуха встаёт и на пороге дремлет.",
    "у {name} зерно во сне считает - и всё равно недосчитывает.",
    "у {name} дружина храбрая ровно до первой кружки.",
    "у {name} ворота скрипят громче, чем хозяин работает.",
    "у {name} в закромах мышь сытее князя.",
    "у {name} нос в чужой амбар, а руки - в свой карман.",
    "у {name} копьё в бою дрожит, а кружка - ни разу.",
    "у {name} двор широкий, а дела - как щель в заборе.",
    "у {name} щедрость хвалят, пока взаймы не попросят.",
    "у {name} петух соседей будит, а хозяин до обеда спит.",
    "у {name} конь умнее седока - и умнее про это молчит.",
    "у {name} шлем блестит, а колени барабанят сами.",
    "у {name} долги после дождя быстрее репы лезут.",
    "у {name} хлеб черствее хозяйской совести.",
    "у {name} собака на воров лает, хозяин - на работу.",
    "у {name} ложка в каше храбрее меча в ножнах.",
    "у {name} гусь жирнее казны, да честнее зерно считает.",
    "у {name} мельница крутится, а мука всё чужая.",
    "у {name} кот мышей ловит лучше, чем хозяин удачу.",
    "у {name} на клятве рука тёплая, на кошельке - ледяная.",
    "у {name} сон крепче дозора: дозор хоть глаза трёт.",
    "у {name} дым из трубы густой, а обеда из него нет.",
    "у {name} ведро в колодце гулко - воды как не бывало.",
    ...
    "у {name} свеча гаснет быстрее терпения дружины.",
    "у {name} мешок с зерном худеет быстрее хозяйской улыбки.",
    "у {name} курица яйца несёт, хозяин - отговорки.",
    "у {name} забор от воров высок, от лени - по колено.",
    "у {name} щит дырявый, зато хвастовство без щели.",
    "у {name} бочка в погребе гулкая - стукни, эхо одно и отдаст.",
    "у {name} в поле спит, а в кабаке орёт.",
    "у {name} кобыла сытее дружины - и умнее её же.",
    "у {name} сторожка стоит, а сторож - в соседней кружке.",
    "от {name} пахнет дымом сильнее, чем жарким обедом.",
    "у {name} будто амбар пустой, а язык полный.",
    "у {name} в набег лев, а на пашню - пень.",
    "у {name} сапоги целы, а храбрость на крыльце протёрлась.",
    "за {name} дружина идёт, пока кружки не кончатся.",
    "у {name} зерно прячут от мышей, а от соседей - отговорками.",
    "у {name} в погребе гулко, на столе жидко.",
    "у {name} будто копьё купил, а руки к нему не приложил.",
    "у {name} хлеб пекут редко, а хвастовство - каждый день.",
    "у {name} кружка тяжелее меча - и поднимается охотнее.",
    "у {name} обещает с три короба, а отдаёт с полковша.",
    "у {name} в бою пятки шустрее рук.",
    "у {name} в кабаке князь, дома - подмётки просит потише.",
    "у {name} храбрость в кувшине, а кувшин уже пустой.",
    "у {name} язык острый, а копьё - как мокрая лоза.",
    "у {name} в кабаке сила ревёт, а в поле язык за щеку прячет.",
    "у {name} нос в чужие дела суёт глубже, чем лопату в свою землю.",
    "у {name} топор в сарае скучает, язык на площади - нет.",
    "у {name} ворота широкие для гостей, узкие для работников.",
)
